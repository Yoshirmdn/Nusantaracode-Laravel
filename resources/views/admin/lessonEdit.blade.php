                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="/admin.courseManage"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-black md:ms-2">Course
                            Management</a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-black md:ms-2">Lessons Edit</a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-semibold">Edit Lesson</h1>
                    <form action="{{ route('lessons.update', $lesson->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                <label for="path_video" class="block text-sm font-medium text-gray-700">Video
                                    Path</label>
